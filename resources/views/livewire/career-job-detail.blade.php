...
<div class="clnbd c8tys c58e1 c9gkl cqikb">
    ...
    <div class="c4ihh cm95r ckoci cbp69 csqne">
        ...
        <!-- Page content -->
        <main class="c8c54">
            <section class="cpsdf c78an" style="background-image:url('{{ asset('images/BG-HIGHWAY.png') }}'); background-size:cover; background-position:center;">
                <div class="bg-black/50">
                    <div class="c9zbf cfacu c0spu cnm0k py-10">
                        ...
                        <h1 class="c5zpx c9gkl c8hbn cn95v text-white mt-4">{{$jobDetails->postingTitle}}</h1>
                    </div>
                </div>
            </section>
